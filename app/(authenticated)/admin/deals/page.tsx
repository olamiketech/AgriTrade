    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900">Trade Deal Oversight</h1>
                    <p className="text-slate-500">Monitor and manage all platform trade transactions.</p>
                </div>
            </div>
                                ...
                                {loading ? (
                                    ...
                                    filteredDeals.map((deal) => (
                                        <tr key={deal.id} className="bg-white hover:bg-slate-50 transition-colors group">
                                            ...
                                            <td className="px-6 py-4 text-slate-600 max-w-[150px] truncate" title={deal.productDetails}>
                                                {deal.productDetails}
                                            </td>
                                            <td className="px-6 py-4 text-slate-600">
                                                {deal.exporter?.companyName || 'Unknown'}
                                            </td>
                                            <td className="px-6 py-4 text-slate-600">
                                                {deal.buyerEmail || 'Pending Inv.'}
                                            </td>
                                            <td className="px-6 py-4 font-medium text-slate-900">
